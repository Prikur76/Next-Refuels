...
### 11.1 Топливозаправщики в справочнике автомобилей
...
### 11.2 Первый круговой график: «Распределение по источникам заправки»
...
### 11.3 Второй блок: «Карта, Telegram-бот и топливозаправщик»
...
### 11.4 Топ-20 по сотрудникам и по автомобилям
...
### 11.5 Docker Compose: переменная `pid` во фронтенд-команде
...
### 11.6 Сборка образов: ошибка BuildKit snapshot
